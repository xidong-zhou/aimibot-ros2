...
void LS01B_Node::initParam()
{
  ...
  //~ std::string  angle_disable_min_0 = "90";
  //~ std::string  angle_disable_max_0 = "270";
  //~ std::string  angle_disable_min_1 = "-1";
  //~ std::string  angle_disable_max_1 = "-1";
  //~ std::string  angle_disable_min_2 = "-1";
  //~ std::string  angle_disable_max_2 = "-1";
  //~ std::string  angle_disable_min_3 = "-1";
  //~ std::string  angle_disable_max_3 = "-1";
  //~ std::string  angle_disable_min_4 = "-1";
  //~ std::string  angle_disable_max_4 = "-1";
  //~ std::string  robot_radius_ = "0.2";
  //~ std::string  center_x_ = "0";
  //~ std::string  center_y_ = "0";
  ...
  baud_rate_ = 4060800;
  angle_resolution_ = 0.25;
  angle_disable_min_0 = 90;
  angle_disable_max_0 = 270;
  angle_disable_min_1 = -1;
  angle_disable_max_1 = -1;
  angle_disable_min_2 = -1;
  angle_disable_max_2 = -1;
  angle_disable_min_3 = -1;
  angle_disable_max_3 = -1;
  angle_disable_min_4 = -1;
  angle_disable_max_4 = -1;
  robot_radius_ = 0.2;
  center_x_ = 0;
  center_y_ = 0;
